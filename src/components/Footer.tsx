    ...
    <footer className="bg-primary text-primary-foreground">
      <div className="container mx-auto px-4 md:px-8 py-12">
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8 mb-8">
          ...
          <div className="space-y-4">
            <div className="flex items-center">
              <img 
                ...
                className="h-22 md:h-26 lg:h-30 w-full max-w-[180px] md:max-w-[210px] lg:max-w-[250px] object-fill"
              />
            </div>
          ...
          <div>
            ...
            <div className="text-sm space-y-2 opacity-90">
              ...
              <p className="text-xs mt-4">Closed: Tuesday</p>
            </div>
          </div>
        </div>
        ...
        <div className="border-t border-primary-foreground/20 pt-6 text-center text-sm opacity-75">
          <p>
            © 2025 ShagunHomes | Designed by <a href="https://www.nexbern.com" target="_blank" rel="noopener noreferrer" > Nexbern Technologies </a>
          </p>
