...
export const TopMiniNav = ({ visible }: TopMiniNavProps) => {
  ...
  return (
    <>
      <div
        className={`hidden md:block fixed top-0 left-0 right-0 z-50 h-10 bg-background border-b border-primary/10 transition-transform duration-300 ${
          visible ? "translate-y-0" : "-translate-y-full"
        }`}
      >
        <div className="container mx-auto px-4 md:px-8 h-full flex items-center justify-end text-sm">
          {/* Social icons - Left */}
