...
const Home = () => {
  ...
  const whyChooseItems = [
    ...
    {
      icon: MapPin,
      title: "Prime Locations in Greater Noida Yamuna Expressway",
      description: "Handpicked neighbourhoods across Greater Noida Yamuna Expressway",
    },
  ];
      ...
      >
        <div className="container mx-auto px-4 md:px-8 text-center">
          ...
          <p className="text-lg md:text-xl mb-8 opacity-90">
            Talk to our Greater Noida Yamuna Expressway experts — Free consultation & guided site visits
          </p>
